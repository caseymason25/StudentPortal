  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved map as @map" do
        ...
        allow_any_instance_of(Map).to receive(:save).and_return(false)
        post :create, {:map => { "latitude" => "invalid value" }}, valid_session
        expect(assigns(:map)).to be_a_new(Map)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested map" do
        ...
        expect_any_instance_of(Map).to receive(:update).with({ "latitude" => "1.5" })
        put :update, {:id => map.to_param, :map => { "latitude" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the map as @map" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Map).to receive(:save).and_return(false)
        put :update, {:id => map.to_param, :map => { "latitude" => "invalid value" }}, valid_session
        expect(assigns(:map)).to eq(map)
      end
